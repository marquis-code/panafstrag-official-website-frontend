<template>
  <Transition name="fade">
    <b-container class="text-white">
      ...
      <article
        v-if="$nuxt.isOnline"
        class="rounded-md bg-white p-6 border sm:p-8 my-6"
      >
        <div class="flex items-start">
          <div
            class="hidden sm:grid sm:h-20 sm:w-20 sm:shrink-0 sm:place-content-center sm:rounded-full sm:p-4 border"
            aria-hidden="true"
          >
