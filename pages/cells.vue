<template>
  <Transition name="fade">
    <b-container class="text-white">
      ...
      <section
        v-if="$nuxt.isOnline"
        class="mt-8 grid grid-cols-1 gap-8 md:gap-6 lg:gap-8 md:grid-cols-2 md:grid-cols-3"
      >
        <div
          class="group relative block bg-gradient-to-r from-green-500 to-black rounded-lg h-72"
        >
