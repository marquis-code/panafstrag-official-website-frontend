  ...
  <b-container>
    <section class="text-white">
      <div class="flex items-center justify-between my-3">
        ...
        <button
          @click="$router.push('/admin/board-members/create')"
          class="
            text-gray-400
            rounded-md
            border
        ...
        >
          ...
          <template #cell(name)="data">
            <div class="flex space-x-2">
              ...
              <div class="flex flex-col">
                ...
                <p
                  v-for="eachEmail in data.item.email"
                  :key="eachEmail"
                  class="font-medium py-2 text-sm pt-0"
                >
                  <span
                    class="mr-2 text-xs"
          ...
          <template #cell(university)="data">
            <span class="font-medium py-2 text-sm">{{
              data?.item?.university == "null"
                ? "N/A"
                : data?.item?.university && data?.item?.university.length > 25
          ...
          <template #cell(position)="data">
            <div class="py-2">
              <p class="font-medium text-sm">
                {{
                  data?.item?.position == "null"
                    ? "N/A"
                    : data?.item?.position && data?.item?.position.length > 25
              ...
              <p class="font-medium text-sm">
                {{
                  data?.item?.faculty == "null" ? "N/A" : data?.item?.faculty
                }}
              </p>
            </div>
          </template>
