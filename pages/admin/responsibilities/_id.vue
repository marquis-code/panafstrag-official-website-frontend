    ...
    async handleSubmit() {
      ...
      try {
        await this.$axios.put(
          `https://panafstrag.onrender.com/api/panAfrica/responsibilities/${this.$route.params.id}`,
          this.form
        );
        this.$toast.success("Responsibility was successfully updated").goAway(1500);
        this.$router.push("/admin/responsibilities");
        this.loading = false;
      } catch (error) {
