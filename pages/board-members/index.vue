      ...
      <main class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        <section v-for="member in boardMembers" :key="member._id">
          <nuxt-link :to="'/board-members/' + member._id">
            <article
              class="overflow-hidden rounded-lg border border-gray-100 shadow-sm h-96"
            >
              <div class="flex pt-3 justify-center items-center relative">
                <div
                  class="animate-spin border-dashed border-2 border-green-500 rounded-full h-56 w-56"
                ></div>
                <img
                  alt="board member"
                  :src="member.avatar"
                  class="cursor-pointer object-cover rounded-full h-52 w-52 shadow-md absolute"
                />
              </div>
              ...
              <div class="p-4 sm:p-6">
                ...
                <p
                  class="mt-2 text-sm leading-relaxed text-gray-500 line-clamp-3 flex flex-wrap space-y-2 items-center"
