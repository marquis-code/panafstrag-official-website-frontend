<template>
  <Transition name="fade">
    <b-container class="text-white">
      ...
      <h2
        v-if="$nuxt.isOnline && activeProgrammes.length"
      ...
      >
        <div v-for="program in activeProgrammes" :key="program._id">
          <article
            class="relative flex bg-white transition shadow-md h-60 border border-gray-100 rounded-md"
          >
            <span
              class="animate-ping absolute inline-flex -top-1 -right-1 h-3 w-3 rounded-full bg-green-400 opacity-75"
            ></span>
      ...
      <h2
        v-if="$nuxt.isOnline && pendingProgrammes.length"
        class="text-base font-medium my-3 text-gray-500"
      >
        Pending Programmes
      </h2>
      <section
      ...
      >
        <div v-for="program in pendingProgrammes" :key="program._id">
          <article
            class="flex bg-white transition shadow-md h-60 border border-gray-100 rounded-md"
          >
            <div class="relative flex flex-1 flex-col justify-between">
              <div class="p-4 sm:p-6">
                <h3
      ...
      <h2
        v-if="$nuxt.isOnline && completedProgrammes.length"
        class="text-base font-medium my-3 text-gray-500"
      >
